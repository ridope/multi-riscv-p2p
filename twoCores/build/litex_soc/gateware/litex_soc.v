...
wire [14:0] main_litexsocgenerator_adr;
...
reg  main_uart_tx0_rs232phytx_next_value1 = 1'd0;
reg  main_uart_tx0_rs232phytx_next_value_ce1 = 1'd0;
...
assign main_litexsocgenerator_adr = main_litexsocgenerator_ram_bus_adr[14:0];
...
always @(*) begin
	...
	main_uart_tx0_rs232phytx_next_value1 <= 1'd0;
	main_tx_sink_ready <= 1'd0;
	main_uart_tx0_rs232phytx_next_value_ce1 <= 1'd0;
	...
	case (builder_rs232phytx_state)
		1'd1: begin
			...
			if (main_tx_tick) begin
				main_uart_tx0_rs232phytx_next_value1 <= main_tx_data;
				main_uart_tx0_rs232phytx_next_value_ce1 <= 1'd1;
		...
		default: begin
			...
			main_tx_count_rs232phytx_next_value_ce0 <= 1'd1;
			main_uart_tx0_rs232phytx_next_value1 <= 1'd1;
			main_uart_tx0_rs232phytx_next_value_ce1 <= 1'd1;
...
assign main_uart_tx1 = main_uart_tx_status;
assign main_uart_tx2 = main_uart_tx_pending;
always @(*) begin
...
assign main_uart_rx1 = main_uart_rx_status;
assign main_uart_rx2 = main_uart_rx_pending;
always @(*) begin
...
assign main_interface0_ack = (builder_shared_ack & (builder_grant == 2'd2));
assign main_ibus_err = (builder_shared_err & (builder_grant == 1'd0));
assign main_dbus_err = (builder_shared_err & (builder_grant == 1'd1));
assign main_interface0_err = (builder_shared_err & (builder_grant == 2'd2));
assign builder_request = {main_interface0_cyc, main_dbus_cyc, main_ibus_cyc};
always @(*) begin
	...
	builder_slave_sel[2] <= (builder_shared_adr[29:26] == 4'd10);
...
assign main_litexsocgenerator_ram_bus_cyc = (builder_shared_cyc & builder_slave_sel[0]);
assign main_ram_bus_ram_bus_cyc = (builder_shared_cyc & builder_slave_sel[1]);
assign main_interface1_cyc = (builder_shared_cyc & builder_slave_sel[2]);
assign builder_litexsocgenerator_wishbone_cyc = (builder_shared_cyc & builder_slave_sel[3]);
assign builder_shared_err = (((main_litexsocgenerator_ram_bus_err | main_ram_bus_ram_bus_err) | main_interface1_err) | builder_litexsocgenerator_wishbone_err);
assign builder_wait = ((builder_shared_stb & builder_shared_cyc) & (~builder_shared_ack));
always @(*) begin
	builder_error <= 1'd0;
	builder_shared_dat_r <= 32'd0;
	builder_shared_ack <= 1'd0;
	builder_shared_ack <= (((main_litexsocgenerator_ram_bus_ack | main_ram_bus_ram_bus_ack) | main_interface1_ack) | builder_litexsocgenerator_wishbone_ack);
	builder_shared_dat_r <= (((({32{builder_slave_sel_r[0]}} & main_litexsocgenerator_ram_bus_dat_r) | ({32{builder_slave_sel_r[1]}} & main_ram_bus_ram_bus_dat_r)) | ({32{builder_slave_sel_r[2]}} & main_interface1_dat_r)) | ({32{builder_slave_sel_r[3]}} & builder_litexsocgenerator_wishbone_dat_r));
...
always @(*) begin
	...
	main_uart_status_status[0] <= main_uart_tx1;
	main_uart_status_status[1] <= main_uart_rx1;
end
...
always @(*) begin
	...
	main_uart_pending_status[0] <= main_uart_tx2;
	main_uart_pending_status[1] <= main_uart_rx2;
end
...
assign main_uart_tx3 = main_uart_enable_storage[0];
assign main_uart_rx3 = main_uart_enable_storage[1];
...
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed0 <= main_interface0_adr;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed1 <= main_interface0_dat_w;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed2 <= main_interface0_sel;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed3 <= main_interface0_cyc;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed4 <= main_interface0_stb;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed5 <= main_interface0_we;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed6 <= main_interface0_cti;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed7 <= main_interface0_bte;
		end
	endcase
end
...
always @(posedge sys_clk) begin
	...
	if (((main_litexsocgenerator_ram_bus_cyc & main_litexsocgenerator_ram_bus_stb) & (~main_litexsocgenerator_ram_bus_ack))) begin
	...
	{main_tx_tick, main_tx_phase} <= 24'd9895604;
	if (main_tx_enable) begin
		{main_tx_tick, main_tx_phase} <= (main_tx_phase + 24'd9895604);
	end
	...
	if (main_uart_tx0_rs232phytx_next_value_ce1) begin
		uart_tx <= main_uart_tx0_rs232phytx_next_value1;
	end
	...
	if (main_rx_enable) begin
		{main_rx_tick, main_rx_phase} <= (main_rx_phase + 24'd9895604);
	end
...
//------------------------------------------------------------------------------
// Memory mem: 6770-words x 32-bit
//------------------------------------------------------------------------------
...
reg [31:0] mem_dat0;
always @(posedge sys_clk) begin
	mem_dat0 <= mem[main_litexsocgenerator_adr];
end
assign main_litexsocgenerator_dat_r = mem_dat0;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-05-10 17:11:55.
//------------------------------------------------------------------------------
