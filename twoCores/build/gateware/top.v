...
reg  leds_re = 1'd0;
wire [4:0] switches_status;
wire switches_we;
reg  switches_re = 1'd0;
wire buttons_status;
wire buttons_we;
reg  buttons_re = 1'd0;
reg  [3:0] display1_storage = 4'd0;
reg  display1_re = 1'd0;
reg  display1_write_re = 1'd0;
wire display1_write_r;
reg  display1_write_we = 1'd0;
reg  display1_write_w = 1'd0;
wire [6:0] display1_abcdefg0;
reg  [3:0] display1_value = 4'd0;
reg  [6:0] display1_abcdefg1 = 7'd0;
reg  [3:0] display2_storage = 4'd0;
reg  display2_re = 1'd0;
reg  display2_write_re = 1'd0;
wire display2_write_r;
reg  display2_write_we = 1'd0;
reg  display2_write_w = 1'd0;
wire [6:0] display2_abcdefg0;
reg  [3:0] display2_value = 4'd0;
reg  [6:0] display2_abcdefg1 = 7'd0;
reg  [3:0] display3_storage = 4'd0;
reg  display3_re = 1'd0;
reg  display3_write_re = 1'd0;
wire display3_write_r;
reg  display3_write_we = 1'd0;
reg  display3_write_w = 1'd0;
...
reg  csr_bankarray_csrbank2_value0_re = 1'd0;
wire [3:0] csr_bankarray_csrbank2_value0_r;
reg  csr_bankarray_csrbank2_value0_we = 1'd0;
wire [3:0] csr_bankarray_csrbank2_value0_w;
...
reg  csr_bankarray_csrbank4_value0_re = 1'd0;
wire [3:0] csr_bankarray_csrbank4_value0_r;
reg  csr_bankarray_csrbank4_value0_we = 1'd0;
wire [3:0] csr_bankarray_csrbank4_value0_w;
...
wire [4:0] csr_bankarray_csrbank5_out0_r;
reg  csr_bankarray_csrbank5_out0_we = 1'd0;
wire [4:0] csr_bankarray_csrbank5_out0_w;
...
reg  csr_bankarray_csrbank6_in_re = 1'd0;
wire [4:0] csr_bankarray_csrbank6_in_r;
reg  csr_bankarray_csrbank6_in_we = 1'd0;
wire [4:0] csr_bankarray_csrbank6_in_w;
...
reg  [4:0] multiregimpl1_regs0 = 5'd0;
reg  [4:0] multiregimpl1_regs1 = 5'd0;
...
assign {user_led4, user_led3, user_led2, user_led1, user_led0} = leds_storage;
...
assign csr_bankarray_csrbank1_sel = (csr_bankarray_interface1_bank_bus_adr[13:9] == 3'd6);
...
assign csr_bankarray_csrbank2_value0_r = csr_bankarray_interface2_bank_bus_dat_w[3:0];
always @(*) begin
	csr_bankarray_csrbank2_value0_re <= 1'd0;
	csr_bankarray_csrbank2_value0_we <= 1'd0;
	if ((csr_bankarray_csrbank2_sel & (csr_bankarray_interface2_bank_bus_adr[8:0] == 1'd0))) begin
		csr_bankarray_csrbank2_value0_re <= csr_bankarray_interface2_bank_bus_we;
		csr_bankarray_csrbank2_value0_we <= (~csr_bankarray_interface2_bank_bus_we);
	end
end
assign display1_write_r = csr_bankarray_interface2_bank_bus_dat_w[0];
always @(*) begin
	display1_write_re <= 1'd0;
	display1_write_we <= 1'd0;
	if ((csr_bankarray_csrbank2_sel & (csr_bankarray_interface2_bank_bus_adr[8:0] == 1'd1))) begin
		display1_write_re <= csr_bankarray_interface2_bank_bus_we;
		display1_write_we <= (~csr_bankarray_interface2_bank_bus_we);
	end
end
assign csr_bankarray_csrbank2_value0_w = display1_storage[3:0];
...
assign display2_write_r = csr_bankarray_interface3_bank_bus_dat_w[0];
always @(*) begin
	display2_write_we <= 1'd0;
	display2_write_re <= 1'd0;
	if ((csr_bankarray_csrbank3_sel & (csr_bankarray_interface3_bank_bus_adr[8:0] == 1'd1))) begin
		display2_write_re <= csr_bankarray_interface3_bank_bus_we;
		display2_write_we <= (~csr_bankarray_interface3_bank_bus_we);
	end
end
assign csr_bankarray_csrbank3_value0_w = display2_storage[3:0];
assign csr_bankarray_csrbank4_sel = (csr_bankarray_interface4_bank_bus_adr[13:9] == 3'd5);
assign csr_bankarray_csrbank4_value0_r = csr_bankarray_interface4_bank_bus_dat_w[3:0];
always @(*) begin
	csr_bankarray_csrbank4_value0_re <= 1'd0;
	csr_bankarray_csrbank4_value0_we <= 1'd0;
	if ((csr_bankarray_csrbank4_sel & (csr_bankarray_interface4_bank_bus_adr[8:0] == 1'd0))) begin
		csr_bankarray_csrbank4_value0_re <= csr_bankarray_interface4_bank_bus_we;
		csr_bankarray_csrbank4_value0_we <= (~csr_bankarray_interface4_bank_bus_we);
	end
end
assign display3_write_r = csr_bankarray_interface4_bank_bus_dat_w[0];
always @(*) begin
	display3_write_re <= 1'd0;
	display3_write_we <= 1'd0;
	if ((csr_bankarray_csrbank4_sel & (csr_bankarray_interface4_bank_bus_adr[8:0] == 1'd1))) begin
		display3_write_re <= csr_bankarray_interface4_bank_bus_we;
		display3_write_we <= (~csr_bankarray_interface4_bank_bus_we);
	end
end
assign csr_bankarray_csrbank4_value0_w = display3_storage[3:0];
...
assign csr_bankarray_csrbank5_out0_r = csr_bankarray_interface5_bank_bus_dat_w[4:0];
always @(*) begin
...
assign csr_bankarray_csrbank5_out0_w = leds_storage[4:0];
assign csr_bankarray_csrbank6_sel = (csr_bankarray_interface6_bank_bus_adr[13:9] == 1'd1);
assign csr_bankarray_csrbank6_in_r = csr_bankarray_interface6_bank_bus_dat_w[4:0];
always @(*) begin
	csr_bankarray_csrbank6_in_we <= 1'd0;
	csr_bankarray_csrbank6_in_re <= 1'd0;
	if ((csr_bankarray_csrbank6_sel & (csr_bankarray_interface6_bank_bus_adr[8:0] == 1'd0))) begin
		csr_bankarray_csrbank6_in_re <= csr_bankarray_interface6_bank_bus_we;
		csr_bankarray_csrbank6_in_we <= (~csr_bankarray_interface6_bank_bus_we);
	end
end
assign csr_bankarray_csrbank6_in_w = switches_status[4:0];
assign switches_we = csr_bankarray_csrbank6_in_we;
...
assign csr_bankarray_csrbank7_load0_w = timer_load_storage[31:0];
assign csr_bankarray_csrbank7_reload0_w = timer_reload_storage[31:0];
assign csr_bankarray_csrbank7_en0_w = timer_en_storage;
assign csr_bankarray_csrbank7_update_value0_w = timer_update_value_storage;
assign csr_bankarray_csrbank7_value_w = timer_value_status[31:0];
assign timer_value_we = csr_bankarray_csrbank7_value_we;
assign timer_status_status = timer_zero0;
assign csr_bankarray_csrbank7_ev_status_w = timer_status_status;
assign timer_status_we = csr_bankarray_csrbank7_ev_status_we;
assign timer_pending_status = timer_zero1;
assign csr_bankarray_csrbank7_ev_pending_w = timer_pending_status;
assign timer_pending_we = csr_bankarray_csrbank7_ev_pending_we;
assign timer_zero2 = timer_enable_storage;
assign csr_bankarray_csrbank7_ev_enable0_w = timer_enable_storage;
assign csr_bankarray_csrbank8_sel = (csr_bankarray_interface8_bank_bus_adr[13:9] == 4'd9);
assign uart_rxtx_r = csr_bankarray_interface8_bank_bus_dat_w[7:0];
always @(*) begin
	uart_rxtx_we <= 1'd0;
	uart_rxtx_re <= 1'd0;
	if ((csr_bankarray_csrbank8_sel & (csr_bankarray_interface8_bank_bus_adr[8:0] == 1'd0))) begin
		uart_rxtx_re <= csr_bankarray_interface8_bank_bus_we;
		uart_rxtx_we <= (~csr_bankarray_interface8_bank_bus_we);
	end
end
...
assign csr_bankarray_csrbank8_txfull_w = uart_txfull_status;
assign uart_txfull_we = csr_bankarray_csrbank8_txfull_we;
assign csr_bankarray_csrbank8_rxempty_w = uart_rxempty_status;
assign uart_rxempty_we = csr_bankarray_csrbank8_rxempty_we;
always @(*) begin
	uart_status_status <= 2'd0;
	uart_status_status[0] <= uart_tx0;
	uart_status_status[1] <= uart_rx0;
end
assign csr_bankarray_csrbank8_ev_status_w = uart_status_status[1:0];
assign uart_status_we = csr_bankarray_csrbank8_ev_status_we;
always @(*) begin
	uart_pending_status <= 2'd0;
	uart_pending_status[0] <= uart_tx1;
	uart_pending_status[1] <= uart_rx1;
end
assign csr_bankarray_csrbank8_ev_pending_w = uart_pending_status[1:0];
assign uart_pending_we = csr_bankarray_csrbank8_ev_pending_we;
assign uart_tx2 = uart_enable_storage[0];
assign uart_rx2 = uart_enable_storage[1];
assign csr_bankarray_csrbank8_ev_enable0_w = uart_enable_storage[1:0];
assign csr_bankarray_csrbank8_txempty_w = uart_txempty_status;
assign uart_txempty_we = csr_bankarray_csrbank8_txempty_we;
assign csr_bankarray_csrbank8_rxfull_w = uart_rxfull_status;
assign uart_rxfull_we = csr_bankarray_csrbank8_rxfull_we;
...
always @(posedge sys_clk) begin
	...
	if (display1_write_re) begin
		display1_value <= display1_storage;
	end
	if (display2_write_re) begin
		display2_value <= display2_storage;
	end
	if (display3_write_re) begin
		display3_value <= display3_storage;
	end
	state <= next_state;
	case (grant)
		1'd0: begin
	...
	if (csr_bankarray_csrbank2_sel) begin
		case (csr_bankarray_interface2_bank_bus_adr[8:0])
			1'd0: begin
				csr_bankarray_interface2_bank_bus_dat_r <= csr_bankarray_csrbank2_value0_w;
			end
			1'd1: begin
				csr_bankarray_interface2_bank_bus_dat_r <= display1_write_w;
			end
		endcase
	end
	if (csr_bankarray_csrbank2_value0_re) begin
		display1_storage[3:0] <= csr_bankarray_csrbank2_value0_r;
	end
	display1_re <= csr_bankarray_csrbank2_value0_re;
	...
	if (csr_bankarray_csrbank3_sel) begin
		case (csr_bankarray_interface3_bank_bus_adr[8:0])
			...
			1'd1: begin
				csr_bankarray_interface3_bank_bus_dat_r <= display2_write_w;
			end
		endcase
	end
	if (csr_bankarray_csrbank3_value0_re) begin
		display2_storage[3:0] <= csr_bankarray_csrbank3_value0_r;
	end
	display2_re <= csr_bankarray_csrbank3_value0_re;
	...
	if (csr_bankarray_csrbank4_sel) begin
		case (csr_bankarray_interface4_bank_bus_adr[8:0])
			1'd0: begin
				csr_bankarray_interface4_bank_bus_dat_r <= csr_bankarray_csrbank4_value0_w;
			end
			1'd1: begin
				csr_bankarray_interface4_bank_bus_dat_r <= display3_write_w;
			end
		endcase
	end
	if (csr_bankarray_csrbank4_value0_re) begin
		display3_storage[3:0] <= csr_bankarray_csrbank4_value0_r;
	end
	display3_re <= csr_bankarray_csrbank4_value0_re;
	...
	if (csr_bankarray_csrbank5_out0_re) begin
		leds_storage[4:0] <= csr_bankarray_csrbank5_out0_r;
	end
	...
	if (csr_bankarray_csrbank6_sel) begin
		case (csr_bankarray_interface6_bank_bus_adr[8:0])
			1'd0: begin
				csr_bankarray_interface6_bank_bus_dat_r <= csr_bankarray_csrbank6_in_w;
			end
		endcase
	end
	switches_re <= csr_bankarray_csrbank6_in_re;
	...
	if (csr_bankarray_csrbank7_load0_re) begin
		timer_load_storage[31:0] <= csr_bankarray_csrbank7_load0_r;
	end
	timer_load_re <= csr_bankarray_csrbank7_load0_re;
	if (csr_bankarray_csrbank7_reload0_re) begin
		timer_reload_storage[31:0] <= csr_bankarray_csrbank7_reload0_r;
	end
	timer_reload_re <= csr_bankarray_csrbank7_reload0_re;
	if (csr_bankarray_csrbank7_en0_re) begin
		timer_en_storage <= csr_bankarray_csrbank7_en0_r;
	end
	timer_en_re <= csr_bankarray_csrbank7_en0_re;
	if (csr_bankarray_csrbank7_update_value0_re) begin
		timer_update_value_storage <= csr_bankarray_csrbank7_update_value0_r;
	end
	timer_update_value_re <= csr_bankarray_csrbank7_update_value0_re;
	timer_value_re <= csr_bankarray_csrbank7_value_re;
	timer_status_re <= csr_bankarray_csrbank7_ev_status_re;
	if (csr_bankarray_csrbank7_ev_pending_re) begin
		timer_pending_r <= csr_bankarray_csrbank7_ev_pending_r;
	end
	timer_pending_re <= csr_bankarray_csrbank7_ev_pending_re;
	if (csr_bankarray_csrbank7_ev_enable0_re) begin
		timer_enable_storage <= csr_bankarray_csrbank7_ev_enable0_r;
	end
	timer_enable_re <= csr_bankarray_csrbank7_ev_enable0_re;
	...
	if (csr_bankarray_csrbank8_sel) begin
		case (csr_bankarray_interface8_bank_bus_adr[8:0])
			1'd0: begin
				csr_bankarray_interface8_bank_bus_dat_r <= uart_rxtx_w;
			end
			1'd1: begin
	...
	uart_txfull_re <= csr_bankarray_csrbank8_txfull_re;
	uart_rxempty_re <= csr_bankarray_csrbank8_rxempty_re;
	uart_status_re <= csr_bankarray_csrbank8_ev_status_re;
	if (csr_bankarray_csrbank8_ev_pending_re) begin
		uart_pending_r[1:0] <= csr_bankarray_csrbank8_ev_pending_r;
	end
	uart_pending_re <= csr_bankarray_csrbank8_ev_pending_re;
	if (csr_bankarray_csrbank8_ev_enable0_re) begin
		uart_enable_storage[1:0] <= csr_bankarray_csrbank8_ev_enable0_r;
	end
	uart_enable_re <= csr_bankarray_csrbank8_ev_enable0_re;
	uart_txempty_re <= csr_bankarray_csrbank8_txempty_re;
	uart_rxfull_re <= csr_bankarray_csrbank8_rxfull_re;
	if (sys_rst) begin
		reset_storage <= 2'd0;
		reset_re <= 1'd0;
		...
		switches_re <= 1'd0;
		buttons_re <= 1'd0;
		display1_storage <= 4'd0;
		display1_re <= 1'd0;
		display1_value <= 4'd0;
		display2_storage <= 4'd0;
		display2_re <= 1'd0;
		display2_value <= 4'd0;
		display3_storage <= 4'd0;
		display3_re <= 1'd0;
		display3_value <= 4'd0;
	...
	multiregimpl1_regs0 <= {user_sw4, user_sw3, user_sw2, user_sw1, user_sw0};
	multiregimpl1_regs1 <= multiregimpl1_regs0;
	multiregimpl2_regs0 <= user_btn;
...
reg [5:0] mem_3_adr0;
always @(posedge sys_clk) begin
	mem_3_adr0 <= csr_bankarray_adr;
end
assign csr_bankarray_dat_r = mem_3[mem_3_adr0];
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-03-16 14:59:22.
//------------------------------------------------------------------------------
