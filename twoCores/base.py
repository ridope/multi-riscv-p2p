...
class MySoC():
	Core0 = CPUBlock(platform = Platform(),clk_freq = 50e6, integrated_main_ram_size = 0x1000)
	Core1 = CPUBlock(platform = Platform(),clk_freq = 50e6, integrated_main_ram_size = 0x1000) #TOFIX: add ram start and size as parameter 
	
    #self.comb #TOFIX: Uart connections between cores
